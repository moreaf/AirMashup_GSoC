<template>
  ...
  <v-layout align-center justify-center row wrap>
    <v-flex lg3 v-for="airport in airports">
       <v-card  v-bind:key="airport.id" class="xxx indigo elevation-20">
          ...
          <v-card-actions class="align-center justify-space-around">
            <v-btn class ="elevation-20 mb-3" color="yellow darken-4" dark @click="sendKML(airport.id)" >LAUNCH OLS</v-btn>
            <v-btn class ="elevation-20 mb-3" color="light-blue lighten-1" dark @click="orbit(airport.id)" >ORBIT</v-btn>
